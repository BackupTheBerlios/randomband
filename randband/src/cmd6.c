	...
	switch (o_ptr->sval)
	{
      /*
		...
		case SV_POTION_RUINATION:
		{
			...
			take_hit(damroll(10, 10), "a potion of Ruination", FALSE);
		...
		case SV_POTION_DETONATIONS:
		{
			...
			take_hit(damroll(50, 20), "a potion of Detonation", FALSE);
		...
		case SV_POTION_DEATH:
		{
			...
			take_hit(5000, "a potion of Death", FALSE);
			ident = TRUE;
			break;
		}
		...
		{
			if (set_tim_invis(p_ptr->tim_invis + rand_range(20, 40)))
			{
				ident = TRUE;
			}
			break;
      ...
      case SV_SCROLL_SUPER_IDENTIFY:
      {
		...
		case SV_SCROLL_ICE:
		{
			...
			if (!(p_ptr->oppose_cold || p_ptr->resist_cold || p_ptr->immune_cold))
				take_hit(rand_range(100, 200), "a Scroll of Ice", TRUE);
			ident = TRUE;
			break;
		}
		...
		case SV_SCROLL_CHAOS:
		{
			...
			if (!p_ptr->resist_chaos)
				take_hit(rand_range(150, 300), "a Scroll of Logrus", TRUE);
			ident = TRUE;
			break;
		}
	...
	switch (sval)
	{
      /*
		...
		case SV_WAND_ROCKETS:
		{
			...
			(void)fire_ball(GF_ROCKET, dir, 250, 2);
			ident = TRUE;
			break;
		}
      */
...
static void do_cmd_activate_aux(int item)
{
   ...
   /*****   NEEDS   REWORKING   *****/
	...
	else if (o_ptr->tval == TV_LITE)
	{
      ...
      if (one_in_(3))
      {
         for (Boost = 1; Boost < 6; Boost++)
         {
            if (one_in_(Boost*Boost)) Hi += rand_range(2, 4);
            if (one_in_(Boost*Boost)) Low += rand_range(2, 4);
            if (one_in_(Boost*Boost)) Size += rand_range(0, 1);
         }
      }
		...
		switch (o_ptr->sval)
		{
         /*
			case SV_YELLOW_GLOWSTONE:
			{
				...
				(void)fire_ball(GF_LITE, dir, rand_range(Low, Hi), Size);
      		if (!(o_ptr->flags3 & TR3_INSTA_ART))
            {
               o_ptr->k_idx = 0;
			...
			{
				msg_print("The glowstone changes to a ball of darkness!");
				(void)fire_ball(GF_DARK, dir, rand_range(Low, Hi), Size);
      		if (!(o_ptr->flags3 & TR3_INSTA_ART))
            {
               o_ptr->k_idx = 0;
               inven_takeoff( item, 255);
			...
			{
				msg_print("The glowstone changes to a ball of cold!");
				(void)fire_ball(GF_COLD, dir, rand_range(Low, Hi), Size);
      		if (!(o_ptr->flags3 & TR3_INSTA_ART))
            {
               o_ptr->k_idx = 0;
               inven_takeoff( item, 255);
			...
			{
				msg_print("The glowstone changes to a ball of electricity!");
				(void)fire_ball(GF_ELEC, dir, rand_range(Low, Hi), Size);
      		if (!(o_ptr->flags3 & TR3_INSTA_ART))
            {
               o_ptr->k_idx = 0;
               inven_takeoff( item, 255);
			...
			{
				msg_print("The glowstone changes to a ball of acid!");
				(void)fire_ball(GF_ACID, dir, rand_range(Low, Hi), Size);
      		if (!(o_ptr->flags3 & TR3_INSTA_ART))
            {
               o_ptr->k_idx = 0;
               inven_takeoff( item, 255);
			...
			{
				msg_print("The glowstone changes to a ball of fire!");
				(void)fire_ball(GF_FIRE, dir, rand_range(Low, Hi), Size);
      		if (!(o_ptr->flags3 & TR3_INSTA_ART))
            {
               o_ptr->k_idx = 0;
               inven_takeoff( item, 255);
			...
			{
				msg_print("The glowstone changes to a ball of poison!");
				(void)fire_ball(GF_POIS, dir, rand_range(Low, Hi), Size);
      		if (!(o_ptr->flags3 & TR3_INSTA_ART))
            {
               o_ptr->k_idx = 0;
               inven_takeoff( item, 255);
			...
			{
				msg_print("The glowstone changes to a ball of sound!");
				(void)fire_ball(GF_SOUND, dir, rand_range(Low, Hi), Size);
      		if (!(o_ptr->flags3 & TR3_INSTA_ART))
            {
               o_ptr->k_idx = 0;
               inven_takeoff( item, 255);
			...
			{
				msg_print("The glowstone changes to a ball of water!");
				(void)fire_ball(GF_WATER, dir, rand_range(Low, Hi), Size);
      		if (!(o_ptr->flags3 & TR3_INSTA_ART))
            {
               o_ptr->k_idx = 0;
               inven_takeoff( item, 255);
			...
			{
				msg_print("The glowstone changes to a ball of ice!");
				(void)fire_ball(GF_ICE, dir, rand_range(Low, Hi), Size);
      		if (!(o_ptr->flags3 & TR3_INSTA_ART))
            {
               o_ptr->k_idx = 0;
               inven_takeoff( item, 255);
			...
			{
				msg_print("The glowstone changes to a ball of arrows!");
				(void)fire_ball(GF_ARROW, dir, rand_range(Low, Hi), Size);
      		if (!(o_ptr->flags3 & TR3_INSTA_ART))
            {
               o_ptr->k_idx = 0;
               inven_takeoff( item, 255);
			...
			{
				msg_print("The glowstone changes to a ball of animal control!");
				(void)fire_ball(GF_CONTROL_ANIMAL, dir, rand_range(Low, Hi), Size);
      		if (!(o_ptr->flags3 & TR3_INSTA_ART))
            {
               o_ptr->k_idx = 0;
               inven_takeoff( item, 255);
			...
			{
				msg_print("The glowstone changes to a ball of undead control!");
				(void)fire_ball(GF_CONTROL_UNDEAD, dir, rand_range(Low, Hi), Size);
      		if (!(o_ptr->flags3 & TR3_INSTA_ART))
            {
               o_ptr->k_idx = 0;
               inven_takeoff( item, 255);
			...
			case SV_SHINING_GLOWSTONE3:
			{
				msg_print("The glowstone changes to a ball of charming!");
				(void)fire_ball(GF_CHARM, dir, rand_range(Low, Hi), Size);
      		if (!(o_ptr->flags3 & TR3_INSTA_ART))
            {
               o_ptr->k_idx = 0;
               inven_takeoff( item, 255);
			...
			{
				msg_print("The glowstone changes to a ball of confusion!");
				(void)fire_ball(GF_CONFUSION, dir, rand_range(Low, Hi), Size);
      		if (!(o_ptr->flags3 & TR3_INSTA_ART))
            {
               o_ptr->k_idx = 0;
               inven_takeoff( item, 255);
			...
			{
				msg_print("The glowstone changes to a ball of shards!");
				(void)fire_ball(GF_SHARDS, dir, rand_range(Low, Hi), Size);
      		if (!(o_ptr->flags3 & TR3_INSTA_ART))
            {
               o_ptr->k_idx = 0;
               inven_takeoff( item, 255);
			...
			{
				msg_print("The glowstone changes to a ball of chaos!");
				(void)fire_ball(GF_CHAOS, dir, rand_range(Low, Hi), Size);
      		if (!(o_ptr->flags3 & TR3_INSTA_ART))
            {
               o_ptr->k_idx = 0;
               inven_takeoff( item, 255);
			...
			{
				msg_print("The glowstone changes to a ball of plasma!");
				(void)fire_ball(GF_PLASMA, dir, rand_range(Low, Hi), Size);
      		if (!(o_ptr->flags3 & TR3_INSTA_ART))
            {
               o_ptr->k_idx = 0;
               inven_takeoff( item, 255);
			...
			{
				msg_print("The glowstone changes to a ball of nether!");
				(void)fire_ball(GF_NETHER, dir, rand_range(Low, Hi), Size);
      		if (!(o_ptr->flags3 & TR3_INSTA_ART))
            {
               o_ptr->k_idx = 0;
               inven_takeoff( item, 255);
			...
			{
				msg_print("The glowstone changes to a ball of nexus!");
				(void)fire_ball(GF_NEXUS, dir, rand_range(Low, Hi), Size);
      		if (!(o_ptr->flags3 & TR3_INSTA_ART))
            {
               o_ptr->k_idx = 0;
               inven_takeoff( item, 255);
			...
			{
				msg_print("The glowstone changes to a ball of inertia!");
				(void)fire_ball(GF_INERTIA, dir, rand_range(Low, Hi), Size);
      		if (!(o_ptr->flags3 & TR3_INSTA_ART))
            {
               o_ptr->k_idx = 0;
               inven_takeoff( item, 255);
			...
			{
				msg_print("The glowstone changes to a ball of force!");
				(void)fire_ball(GF_FORCE, dir, rand_range(Low, Hi), Size);
      		if (!(o_ptr->flags3 & TR3_INSTA_ART))
            {
               o_ptr->k_idx = 0;
               inven_takeoff( item, 255);
			...
			{
				msg_print("The glowstone changes to a ball of missiles!");
				(void)fire_ball(GF_MISSILE, dir, rand_range(Low, Hi), Size);
      		if (!(o_ptr->flags3 & TR3_INSTA_ART))
            {
               o_ptr->k_idx = 0;
               inven_takeoff( item, 255);
			...
			{
				msg_print("The glowstone changes to a ball of mana!");
				(void)fire_ball(GF_MANA, dir, rand_range(Low, Hi), Size);
      		if (!(o_ptr->flags3 & TR3_INSTA_ART))
            {
               o_ptr->k_idx = 0;
               inven_takeoff( item, 255);
			...
			{
				msg_print("The glowstone changes to a ball of meteors!");
				(void)fire_ball(GF_METEOR, dir, rand_range(Low, Hi), Size);
      		if (!(o_ptr->flags3 & TR3_INSTA_ART))
            {
               o_ptr->k_idx = 0;
               inven_takeoff( item, 255);
			...
			{
				msg_print("The glowstone changes to a ball of holy fire!");
				(void)fire_ball(GF_HOLY_FIRE, dir, rand_range(Low, Hi), Size);
      		if (!(o_ptr->flags3 & TR3_INSTA_ART))
            {
               o_ptr->k_idx = 0;
               inven_takeoff( item, 255);
			...
			{
				msg_print("The glowstone changes to a ball of hell fire!");
				(void)fire_ball(GF_HELL_FIRE, dir, rand_range(Low, Hi), Size);
      		if (!(o_ptr->flags3 & TR3_INSTA_ART))
            {
               o_ptr->k_idx = 0;
               inven_takeoff( item, 255);
			...
			{
				msg_print("The glowstone changes to a ball of disintegration!");
				(void)fire_ball(GF_DISINTEGRATE, dir, rand_range(Low, Hi), Size);
      		if (!(o_ptr->flags3 & TR3_INSTA_ART))
            {
               o_ptr->k_idx = 0;
               inven_takeoff( item, 255);
			...
			{
				msg_print("The glowstone changes to a ball of death!");
				(void)fire_ball(GF_DEATH_RAY, dir, rand_range(Low, Hi), Size);
      		if (!(o_ptr->flags3 & TR3_INSTA_ART))
            {
               o_ptr->k_idx = 0;
               inven_takeoff( item, 255);
			...
			{
				msg_print("The glowstone changes to a ball of dispell good!");
				(void)fire_ball(GF_DISP_GOOD, dir, rand_range(Low, Hi), Size);
      		if (!(o_ptr->flags3 & TR3_INSTA_ART))
            {
               o_ptr->k_idx = 0;
               inven_takeoff( item, 255);
			...
			{
				msg_print("The glowstone changes to a ball of dispell evil!");
				(void)fire_ball(GF_DISP_EVIL, dir, rand_range(Low, Hi), Size);
      		if (!(o_ptr->flags3 & TR3_INSTA_ART))
            {
               o_ptr->k_idx = 0;
               inven_takeoff( item, 255);
			...
			{
				msg_print("The glowstone changes to a ball of dispell undead!");
				(void)fire_ball(GF_DISP_UNDEAD, dir, rand_range(Low, Hi), Size);
      		if (!(o_ptr->flags3 & TR3_INSTA_ART))
            {
               o_ptr->k_idx = 0;
               inven_takeoff( item, 255);
			...
			{
				msg_print("The glowstone changes to a ball of dispell living!");
				(void)fire_ball(GF_DISP_LIVING, dir, rand_range(Low, Hi), Size);
      		if (!(o_ptr->flags3 & TR3_INSTA_ART))
            {
               o_ptr->k_idx = 0;
               inven_takeoff( item, 255);
			...
			{
				msg_print("The glowstone changes to a ball of rockets!");
				(void)fire_ball(GF_ROCKET, dir, rand_range(Low, Hi), Size);
      		if (!(o_ptr->flags3 & TR3_INSTA_ART))
            {
               o_ptr->k_idx = 0;
               inven_takeoff( item, 255);
			...
			{
				msg_print("The glowstone changes to a ball of nukes!");
				(void)fire_ball(GF_NUKE, dir, rand_range(Low, Hi), Size);
      		if (!(o_ptr->flags3 & TR3_INSTA_ART))
            {
               o_ptr->k_idx = 0;
               inven_takeoff( item, 255);
			...
			{
				msg_print("The glowstone changes to a ball of dispell demon!");
				(void)fire_ball(GF_DISP_DEMON, dir, rand_range(Low, Hi), Size);
      		if (!(o_ptr->flags3 & TR3_INSTA_ART))
            {
               o_ptr->k_idx = 0;
               inven_takeoff( item, 255);
			...
			{
				msg_print("The glowstone changes to a ball of dispelling!");
				(void)fire_ball(GF_DISP_ALL, dir, rand_range(Low, Hi), Size);
      		if (!(o_ptr->flags3 & TR3_INSTA_ART))
            {
               o_ptr->k_idx = 0;
               inven_takeoff( item, 255);
